...
RUN comfy model download --url https://huggingface.co/lightx2v/Wan2.2-Lightning/resolve/main/loras/Wan2.2-Lightning_T2V-v1.1-A14B-4steps-lora_HIGH_fp16.safetensors --relative-path models/loras --filename Wan2.2-Lightning_T2V-v1.1-A14B-4steps-lora_HIGH_fp16.safetensors
...
RUN comfy model download --url https://drive.google.com/uc?export=download&id=1yqAC9dOsEx-1_sRkBXz4VnI8B4oK2DAK --relative-path models/loras --filename Casey.safetensors
# RUN # Could not find URL for Casey.safetensors
